...
async def run_e2e_v16():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                await page.wait_for_selector("#cf-hcaptcha-container", state="detached", timeout=60000)
                print("✅ Cloudflare Challenge Solved!")
            except Exception:
                print("⚠️ Cloudflare challenge timeout or already gone. Proceeding.")
            ...
            if 'otp' in current_url.lower():
                ...
                await page.screenshot(path="screenshots/e2e_v16_result.png")
            
        except Exception as e:
            print(f"❌ Playwright Error: {e}")
            await page.screenshot(path="screenshots/e2e_v16_error.png")
            print(f"🔗 Current URL: {page.url}")
        finally:
            await browser.close()

asyncio.run(run_e2e_v16())
