...
async def run_e2e_v8():
    ...
    async with async_playwright() as p:
        ...
        try:
            print("🌐 Navigating to VFS Login (networkidle, 120s timeout)...")
            await page.goto("https://visa.vfsglobal.com/tur/tr/fra/login", wait_until="networkidle", timeout=120000)
            
            print("⏳ Waiting 20s for Angular UI to fully render...")
            ...
            await page.screenshot(path="screenshots/e2e_v8_error.png")
            print(f"🔗 Current URL: {page.url}")
        finally:
            await browser.close()

asyncio.run(run_e2e_v8())
