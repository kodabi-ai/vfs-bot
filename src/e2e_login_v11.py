...
async def run_e2e_v11():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Explicit wait for Cloudflare JS Challenge
            print("⏳ Waiting 60s for Cloudflare Challenge to resolve...")
            ...
            await page.screenshot(path="screenshots/e2e_v11_error.png")
